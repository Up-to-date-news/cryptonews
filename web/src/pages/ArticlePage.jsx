...
export default function ArticlePage() {
  ...
  // English content for articles enriched before this existed, or
  // manually-created admin posts that never get a Tamil version.
  const displayContent = language === 'ta' && article?.content_ta ? article.content_ta : article?.content;
  ...
  return (
    <article className="article-page">
      ...
      <p className="article-content">{displayContent ?? 'Content unavailable for this article.'}</p>
